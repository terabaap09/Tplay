...
const generateM3u = async (ud) => {
  ...
  for (let i = 0; i < chansList.length; i++) {
    ...
    m3uStr += 'group-title="JOIN US @NINJATV3 |' + (chansList[i].group_title) + '"https://ninjatv.lol/tata/copy.png,  tvg-logo="https://ninjatv.lol/tata/copy.png' + (chansList[i].tvg_logo) + '", NINJA TV'  + chansList[i].name + '\n';
